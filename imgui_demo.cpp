...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        ImGui::SameLine();
        HelpMarker("When not specified explicitly (Auto/Current mode), user can right-click the picker to "
                   "change mode.");
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
        ...
        HelpMarker("Only using TableNextColumn(), which tends to be convenient for tables where every cell "
    ...
    if (ImGui::TreeNode("Row height"))
    {
        HelpMarker("You can pass a 'min_row_height' to TableNextRow().\n\nRows are padded with "
                   ...
                   "that would require a unique clipping rectangle per row.");
    ...
    if (ImGui::TreeNode("Advanced"))
    {
                              ...
                              outer_size_enabled ? outer_size_value : ImVec2(0, 0), inner_width_to_use))
        {
            ...
            ImGui::TableSetupColumn("Quantity", ImGuiTableColumnFlags_PreferSortDescending, 0.0f,
                                    MyItemColumnID_Quantity);
            ImGui::TableSetupColumn(
              "Description", (flags & ImGuiTableFlags_NoHostExtendX) ? 0 : ImGuiTableColumnFlags_WidthStretch,
...
static void ShowDemoWindowInputs()
{
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if (ImGui::TreeNode("Shortcut Routing"))
        {
            ...
            ImGui::RadioButton("ImGuiInputFlags_RouteFocused (default)", &routing_flags,
            ...
            ImGui::RadioButton("ImGuiInputFlags_RouteGlobalHigh", &routing_flags,
                               ImGuiInputFlags_RouteGlobalHigh);
            ImGui::RadioButton("ImGuiInputFlags_RouteGlobalLow", &routing_flags,
            ...
            ImGui::Text("IsWindowFocused: %d, Shortcut: %s", ImGui::IsWindowFocused(),
                        ImGui::Shortcut(key_chord, 0, flags) ? "PRESSED" : "...");
            ...
            ImGui::SameLine();
            HelpMarker("Internal widgets always use _RouteFocused");
            ImGui::Text("IsWindowFocused: %d, Shortcut: %s", ImGui::IsWindowFocused(),
                        ImGui::Shortcut(key_chord, item_id, flags) ? "PRESSED" : "...");
            ...
            if (ImGui::BeginPopup("PopupF"))
            {
                ...
                ImGui::Text("IsWindowFocused: %d, Shortcut: %s", ImGui::IsWindowFocused(),
                            ImGui::Shortcut(key_chord, ImGui::GetItemID(), flags) ? "PRESSED" : "...");
                ImGui::EndPopup();
            }
            ImGui::EndChild();

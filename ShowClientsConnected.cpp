...
{
    {
        ...
        // Using ImGui make a window for showing the number of connections, connection names, character name, character class, location, party_id and party size.

        ImGui::Begin("Connected clients 2");
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            ImGui::PushID(i);
            if (ImGui::ImageButton(skill.skill_icon_texture, ImVec2(20, 20)))
            {
                // Handle button click
            }
            ImGui::PopID();
